...
public class BodyTemperatureAdapter extends FirestoreRecyclerAdapter<Vitals, BodyTemperatureAdapter.VitalsViewHolder> {
    Context context;

    public BodyTemperatureAdapter(@NonNull FirestoreRecyclerOptions<Vitals> options, Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull VitalsViewHolder holder, int position, @NonNull Vitals vital) {
        holder.dataTextView.setText(String.valueOf(vital.data + "°F\n"));
