...
import com.example.mavhealth.ui.ContactActivity;
...
public class MainActivity extends AppCompatActivity{
    ...
    MaterialButton notesBtn, medBtn, vitalsBtn, communicationsBtn;
    ImageButton menuBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        communicationsBtn = findViewById(R.id.comm_dashboard_btn);
        communicationsBtn.setOnClickListener((v)-> startActivity(new Intent(MainActivity.this, ContactActivity.class)));
    }
